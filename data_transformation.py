...
def main():
    ...
    if FLAGS.mode == 'imputation':
        ...
        columns = ['acc_x', 'acc_y', 'acc_z', 'gyr_x', 'gyr_y', 'gyr_z', 'mag_x', 'mag_y', 'mag_z', 'loc_speed']
        for col in columns:
            fs = float(1000)/milliseconds_per_instance
            cutoff = 0.45
            # Let us study acc_phone_x:
        ...
        periodic_measurements = ['acc_x', 'acc_y', 'acc_z', 'gyr_x', 'gyr_y', 'gyr_z', 'mag_x', 'mag_y', 'mag_z']
        ...
        DataViz.plot_dataset(dataset, ['acc_', 'gyr_', 'hr_bpm', 'mag_', 'pca_', 'label'],
